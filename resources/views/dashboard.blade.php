            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                ...
                <div class="relative bg-white p-6 rounded-2xl shadow-xl border border-gray-100 overflow-hidden transform hover:scale-[1.02] transition duration-300 group">
                    ...
                    <div class="relative">
                        ...
                        <a href="{{ route('home') }}" class="text-sm font-medium text-green-600 hover:text-green-900 flex items-center">
    Lihat Semua Laporan <span class="ml-1">&rarr;</span>
                ...
                <div class="relative bg-white p-6 rounded-2xl shadow-xl border border-gray-100 overflow-hidden transform hover:scale-[1.02] transition duration-300 group">
                    ...
                    <div class="relative">
                        ...
                        <span class="block text-5xl font-extrabold text-yellow-600 mb-2">{{ $sedangDiproses }}</span>
                ...
                <div class="relative bg-white p-6 rounded-2xl shadow-xl border border-gray-100 overflow-hidden transform hover:scale-[1.02] transition duration-300 group">
                    ...
                    <div class="relative">
                        ...
                        <span class="block text-5xl font-extrabold text-green-600 mb-2">{{ $sudahSelesai }}</span>
