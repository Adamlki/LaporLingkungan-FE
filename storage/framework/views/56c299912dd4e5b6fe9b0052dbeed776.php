...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.nav-link','data' => ['href' => route('laporan.index'),'active' => request()->routeIs('laporan.index')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('laporan.index')),'active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->routeIs('laporan.index'))]); ?>
                        <?php echo e(__('Laporan Warga')); ?>
...
<?php endif; ?>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                <div id="guest-menu" class="flex space-x-2">
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="font-semibold text-white bg-indigo-600 hover:bg-indigo-700 rounded-md transition duration-150 px-4 py-2 text-base shadow-md">
                        Daftar
                    </a>
                </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.responsive-nav-link','data' => ['href' => route('laporan.index'),'active' => request()->routeIs('laporan.index')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
</nav><?php /**PATH C:\laragon\www\ProjectWEB\LaporLingkungan-FE\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>